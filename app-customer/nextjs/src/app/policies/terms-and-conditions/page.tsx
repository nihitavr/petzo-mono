export default function TermsAndConditions() {
  return (
    <div>
      ...
      <p className="mb-4">
        We are ANA Pet Essentials and Technology (referred to as
        &quot;Furclub&quot;, &quot;Company&quot;, &quot;we&quot;,
      ...
      <p className="mb-4">
        We operate the website <span className="font-semibold">furclub.in</span>{" "}
      ...
      <p className="mb-4">
        ...
        <span className="font-semibold"> furclub.official@gmail.com</span>, or
        by mail to ANA Pet Essentials and Technology, Flat no. A-004, Ground
        floor, Euphoria apartment, 2nd. main road. no. 14, Aswini layout,
        Ejipura, Koramangla, Bengaluru Urban, Karnataka - 560047 India
      </p>
      <p className="mb-4">
        These Legal Terms constitute a legally binding agreement made between
        you, whether personally or on behalf of an entity ( &quot;you&quot;),
        and Furclub, concerning your access to and use of the Services. You
      ...
      <p className="mb-4">
        ...
        address your request to: furclub.official@gmail.com. If we ever grant
      ...
      <p className="mb-4">
        ...
        India . Furclub and yourself irrevocably consent that the courts of
