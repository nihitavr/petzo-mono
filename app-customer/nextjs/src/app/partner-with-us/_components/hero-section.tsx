...
export default function HeroSection() {
  ...
  return (
    <div className="grid grid-cols-2 gap-44 sm:gap-0">
      <div className="col-span-2 flex flex-col pb-8 pt-5 sm:col-span-1 md:gap-1 md:pt-16">
        <h1 className="text-3xl font-semibold md:text-4xl lg:text-5xl">
          ...
          <span>Grow Your</span>
          <span className="inline-block">Pet Care Business</span>
        </h1>
      ...
      <div className="relative col-span-2 grid grid-cols-2 rounded-2xl bg-foreground/10 p-6">
        ...
        <div className="absolute right-0 top-0 col-span-1 h-96 w-full px-2 sm:w-1/2 md:inline md:px-0">
          <div className="relative h-full w-full -translate-y-[68%] md:-translate-y-[55%]">
